...
class Engine {
   ...
   * @param {String} message The UCI-compatible command to feed the engine
  ...
  send(message, callback) {
    ...
    this.logger.log('Sending', message); // Output command to console
    this.last_command = message; // Save last command
    this.engine.postMessage(message); // Send command to engine
